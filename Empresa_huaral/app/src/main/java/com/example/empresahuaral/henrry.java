...
public class henrry extends AppCompatActivity {

    // Declarar las vistas que necesitaremos para las cantidades de dalias
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_henrry);
